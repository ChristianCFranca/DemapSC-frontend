...
export default new Vuex.Store({
  ...
  actions: {
    ...
    getQuantitativos({ commit, dispatch }, dataForQuantitativo) {
      ...
      if (dataForQuantitativo.tipo == 1)
        return apiClient.get(`/collect-data/quantitativosEmpresa?empresa=${dataForQuantitativo.empresa}&mes=${dataForQuantitativo.mes}&ano=${dataForQuantitativo.ano}`)
        .then(response => {
        ...
        return apiClient.get(`/collect-data/quantitativosCartao?mes=${dataForQuantitativo.mes}&ano=${dataForQuantitativo.ano}`)
        .then(response => {
          commit('SET_SNACKBAR', {message: "Quantitativos obtidos com sucesso", color: "success"})
      ...
      commit('SET_SNACKBAR', {message: "Nenhuma opção foi selecionada para a busca", color: "error"})
    },
  ...
  getters: {
    ...
    getCurrentCartaoCorpQuantitativos: state => state.quantitativos.cartaoCorp,
